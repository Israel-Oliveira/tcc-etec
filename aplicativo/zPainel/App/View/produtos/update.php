...
if(isset($_POST['btnCadastrarProdutos'])){
    ...
    $Produtos->updateProdutos($_GET["id"], $_POST['status'], $_POST['nome'], $imgCardProduto , $_POST['subtitulo-produto'], $_POST['preco-produto'], $imgPrincipalProduto, $_POST['descricao-produto'], $_POST['categoria']);
...
<form id="formulario" action=""  method="post" enctype="multipart/form-data">
    ...
    <!-- NOME PRODUTO -->
    <div class="mb-3">
        <input required type="text" class="form-control" id="exampleFormControlInput1" name="nome" placeholder="Digite o nome do Produto" value="<?=$produto[0]["nome"];?>">
    </div>

    <!-- SUBTITULO PRODUTO -->
    <div class="mb-3">
        <input required type="text" class="form-control" id="exampleFormControlInput1" name="subtitulo-produto" placeholder="Digite subtitulo do Produto" value="<?=$produto[0]["subtituloProduto"];?>">
    </div>

    <img style="max-width: 250px; margin: 0 auto" src="../assets/upload/imgs/produtos/<?=$produto[0]["imgCardProduto"];?>" alt="">
    ...
    <div style="display:flex; justify-content:space-between">
        ...
        <div class="mb-3" style="display: flex; gap: 10px;">
            ...
            <input required type="text" class="form-control" id="exampleFormControlInput1" name="preco-produto" placeholder="R$ 0,00" style="width:100px" value="<?=$produto[0]["precoProduto"];?>">
        </div>

        <!-- CATEGORIA PRODUTO -->
        <select name="categoria" class="form-select" aria-label="Default select example" style="width: 200px; height: 40px">
            <option selected><?=$produto[0]["categoria"];?></option>
    ...
    <img style="max-width: 250px; margin: 0 auto" src="../assets/upload/imgs/produtos/<?=$produto[0]["imgPrincipalProduto"];?>" alt="">
    ...
    <div class="form-floating">
        <textarea class="form-control" placeholder="Descrição do produto..." id="floatingTextarea2" name="descricao-produto" style="height: 100px"><?=$produto[0]["descricaoProduto"];?></textarea>
