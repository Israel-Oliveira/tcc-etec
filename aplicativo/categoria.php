...
<section>
  <div class="containeer">
    <div id="categorias" style="background-color: white;">

      <?php foreach ($Produtos->getProdutosCategorias($_GET['categoriaId']) as $produto) { ?>

          <a href="./produto.php?id=<?=$produto['id']?>&categoriaId=<?=$_GET['categoriaId']?>" class="card">
            <div class="card-img">
              <img src="./zPainel/App/View/assets/upload/imgs/produtos/<?=$produto['imgCardProduto']?>" alt="">
            </div>
            <div class="card-info">
              <p class="text-title"><?=$produto['nome']?></p>
              <p class="text-body"><?=$produto['subtituloProduto']?></p>
            </div>
            <div class="card-footer">
              <span class="text-title"><?=$produto['precoProduto']?></span>
